...
abstract class WordModifier {
  ...
  Future<bool> updateMeanings(String wordId, List<Map<String, String>> meanings);
...
class WordListPageState extends State<WordListPage> with WidgetsBindingObserver, SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  Widget _buildWordDecoration({required Widget child, required bool isBookmarked, required bool isDarkMode}) {
    return Container(
  ...
  Widget _buildWordIndexContainer(int i, bool isBookmarked) {
    return Container(
      width: 32,
      height: 32,
      decoration: BoxDecoration(
