...
extension BdcPageStateDialogs on BdcPageState {
  ...
  /// 外观主题入口项：展示当前主题，点击后弹出主题选择弹窗
  Widget _buildThemeEntry(BuildContext dialogContext) {
    final themeStyle = dialogContext.read<DarkMode>().themeStyle;
    return ListTile(
  ...
  /// 主题选择弹窗 (复刻"我的"页面可视化主题选择器)
  Future<void> showThemeSelectDlg() async {
    return showDialog<void>(
      context: context,
      builder: (dialogContext) {
        final selectedStyle = dialogContext.watch<DarkMode>().themeStyle;
        final isDark = selectedStyle.isDark;
        return AlertDialog(
          ...
          title: Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.palette_outlined, color: Global.highlight, size: 22),
            ...
            children: AppThemeStyle.values.map((style) {
              ...
              return Expanded(
                child: GestureDetector(
                  ...
                  onTap: () {
                    dialogContext.read<DarkMode>().setThemeStyle(style);
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          ...
                          color: isSelected
                              ? cfg.primaryColor
                              : Theme.of(dialogContext).iconTheme.color,
                        ),
