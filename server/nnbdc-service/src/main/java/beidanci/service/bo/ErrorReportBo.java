...
public class ErrorReportBo extends BaseBo<ErrorReport> {
    ...
    public Result<String> saveErrorReport(String spell, String content, String userId, String clientType, String imageFiles) {
        // 检查 userId 是否为空
        ...
        errorReport.setImageFiles(imageFiles);
