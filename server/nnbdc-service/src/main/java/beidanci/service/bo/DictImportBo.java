...
public class DictImportBo {
    ...
    public void executeImportTask(String taskId) {
        ...
        try {
            ...
            String meaningRequirement = (String) config.get("meaningRequirement");
    ...
    private AiResult getAiResult(String spell, String manualMeaning, String context, boolean generateWordImage, String dictNameContext, String sentenceRequirement, String meaningRequirement) {
        ...
        if (sentenceRequirement != null && !sentenceRequirement.trim().isEmpty()) {
            systemPrompt += "\nADDITIONAL EXAMPLE SENTENCE REQUIREMENT (IMPORTANT): " + sentenceRequirement;
        }
        if (meaningRequirement != null && !meaningRequirement.trim().isEmpty() && manualMeaning == null) {
            systemPrompt += "\nADDITIONAL WORD MEANING REQUIREMENT (IMPORTANT): " + meaningRequirement;
        }
